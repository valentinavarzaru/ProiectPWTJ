package proiectlaborator.proiect1.aspects;
...
import proiectlaborator.proiect1.utils.ErrorResponse;
...
public class ExceptionHandling {
    ...
    public ResponseEntity<Object> retriveClientValidation(ObjectNotFoundException exception){
        Map<String, Object> body = new HashMap<>();
        body.put("timestamp", LocalDate.now());
